...
Base.Array(A::AbstractSparseDimArray) = Array(parent(A))

@inline function rebuild(A::AbstractSparseDimArray, data::AbstractSparseArray, dims::Tuple, refdims::Tuple, name, metadata)
