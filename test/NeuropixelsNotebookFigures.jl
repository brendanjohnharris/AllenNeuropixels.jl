...
AN.Plots.formattedreferencevolume(session,
                                  "C:\\Users\\Brendan\\Dropbox (Sydney Uni Student)\\AllenNeuropixels\\probelocations.html")

data = AN.getdownsampledlfp(session, probeid);
fig = AN.Plots.neuroslidingcarpet(data; size = (800, 800));
